...
//var exitButton = $('<a class="close"><img src="img/remove_button_invert.png" width="64" alt="arrow"></a>');
var prevButton = $('<a class="prev"><img src="img/arrow_invert.png" width="44" alt="prev-arrow">previous page</a>');
var nextButton = $('<a class="next"><img src="img/arrow_invert_right.png" width="44" alt="next-arrow">next image</a>');

var cover = $('.gallery-set');
//var myModal = $('#myModal');


  // Add Overlay And Buttons
  overlay.appendTo('html').hide();//$("#gallery").append($overlay);
  ...
  /**
   * 
   * Click On Next Button In Lightbox
   * 
   */
  ...
  /**
   * 
   * After Click On Arrow Left Slide Next Picture
   * 
   */
    ...
    /**
     * 
     *  Click On Previous Button In Lightbox
     * 
     */
